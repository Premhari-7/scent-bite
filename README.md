...
git clone https://github.com/Premhari-7/scent-bite-capstone.git cd scent-bite-capstone

2. Install Dependencies
npm install

3. Start Backend Server
cd src/server node Server.cjs
...
Local MongoDB: mongodb://localhost:27017/UserDB

MongoDB Atlas: Configure using environment variables for production use.

Developer
Prem Hari S Full-Stack Developer
...
This project is the intellectual property of Prem Hari S. Unauthorized reproduction, redistribution, or commercial use without explicit permission is strictly prohibited.
